...
This project is a Helm chart for deploying PostgreSQL database on Kubernetes. It is designed for use with cloud management platforms like Morpheus.
...
- **PostgreSQL Deployment**: PostgreSQL 15-alpine container
- **Service**: ClusterIP service (port 5432)
...
- **Database Image**: PostgreSQL image repository and tag
- **Storage Size**: PVC size (default: 10Gi)
- **Credentials**: Database name, username, and password
...
7. Specify the path to your chart as **Chart Path** (e.g., `postgresql-database`)
...
2. Click **+ ADD** button
3. Select the PostgreSQL blueprint you created
