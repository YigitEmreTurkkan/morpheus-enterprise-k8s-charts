# MySQL Database Helm Chart

This project is a Helm chart for deploying MySQL database on Kubernetes. It is designed for use with cloud management platforms like Morpheus.
...
- **MySQL Deployment**: MySQL 8.0 container
...
- **Database Image**: MySQL image repository and tag
...
git init
git add .
git commit -m "MySQL Helm chart for Morpheus"
...
7. Specify the path to your chart as **Chart Path** (e.g., `mysql-database`)
...
2. Click **+ ADD** button
3. Select the MySQL blueprint you created
